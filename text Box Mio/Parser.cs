...
namespace at.jku.ssw.cc
{
    ...
    class Parser
    {
        ...
        {  //visto  //si es "int[] pos" y viene de "Class Tabla {", kind es "Field"
            ...
            MessageBoxCon3Preg();//03-11-21
            Code.Colorear("latoken");
            Identifieropc(hijo2, type, kind); // el Metodo IdentifierOpc contiene un MessageBox
            Check(Token.SEMICOLON);
            MessageBoxCon3Preg();
            Code.seleccLaProdEnLaGram(6);
            MessageBoxCon3Preg(); //04-11-21
            Code.Colorear("token");
            padre.Nodes.Add("';'");
            MessageBoxCon3Preg();
